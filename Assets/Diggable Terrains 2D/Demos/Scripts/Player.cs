...
namespace ScriptBoy.DiggableTerrains2D_Demos
{
    ...
    {
        [Space] [SerializeField] Shovel m_Shovel;
        ...
        [Space] [SerializeField] AudioClip m_DigSound;
        [SerializeField] AudioClip m_FootstepSound;
        [SerializeField] AudioClip m_RocketSound;

        [Space] [SerializeField] float m_RunSpeed;
        private Vector3 m_Velocity;
        private float m_JumpForce;
        [SerializeField] bool m_IsGrounded;
        private float m_Gravity = 9f;


        [Space] [SerializeField] Transform m_RocketAimPivot;
        ...
        [Space] [SerializeField] Limb m_LeftArm;
        [SerializeField] Limb m_RightArm;

        [Space] [SerializeField] State m_NormalState;
